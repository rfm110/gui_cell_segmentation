...
for orig, seg in image_pair_dictionary.iteritems():
    ...
    right_panel_segmented.bind('<Button 1>',lambda event: click_event(event))
    click_position = (x_click, y_click)

    right_panel_segmented.unbind('<Button-1>')
    print position_list
    # TODO: ADD UNDO BUTTON? to undo a click?
    # print x_click
...
print "x click is ", x_click
print "y click is ", y_click
print xclick2